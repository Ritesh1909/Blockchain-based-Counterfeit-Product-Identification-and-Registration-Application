...
<div class="bg-image">
    <img src="assets/images/bg-themes/pst.jpg" alt="backgroundimage"    width="600px" height="300px;">
	
 </div>
<h1><a href="ureview1.jsp">Positive Review Block</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="uneg1.jsp">Negative Review Block</a></h1>
 <div class="card mt-3">
