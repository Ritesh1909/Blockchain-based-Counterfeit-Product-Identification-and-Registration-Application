...
/*        margin-left: 250px;*/
    ...
    .bg-image{
        ...
        <h2>View Products and Review & Rating</h2>
        <div class="col-lg-22" >
          <div class="card" >
            <div class="card-body">
             ...
             <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col" style="color: white;">QR CODE</th>
...
%>
                ...
                <tbody>
                 ...
                 <td><%=price%></td>
                 <td><%=spec%></td>
                 <td><a href="qr.jsp?pid=<%=pid%>&&pname=<%=pname%>&&pcat=<%=pcat%>&&pbrand=<%=pbrand%>&&price=<%=price%>&&spec=<%=spec%>" style="color: Black; font-weight: bolder;">Generate </a></td>  
                
                <td><a href="review1.jsp?user=<%=user%>&&pid=<%=pid%>&&pname=<%=pname%>&&pcat=<%=pcat%>&&pbrand=<%=pbrand%>&&price=<%=price%>&&spec=<%=spec%>" style="color: Black; font-weight: bolder;">Review </a></td>  
