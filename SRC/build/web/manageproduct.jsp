             ...
             <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col" style="color: white;">Generate QR CODE</th>
                  </tr>
                </thead>
                <%
                ...
                <tbody>
                 ...
                 <td><%=price%></td>
                 <td><%=spec%></td>
                 <td><a href="update.jsp?pid=<%=pid%>&&pname=<%=pname%>&&pcat=<%=pcat%>&&pbrand=<%=pbrand%>&&price=<%=price%>&&spec=<%=spec%>" style="color: Black; font-weight: bolder;">Update</a>/<a href="delet.jsp?sno=<%=sno%>">Delete</a></td>  
                
                 <td><a href="qr.jsp?pid=<%=pid%>&&pname=<%=pname%>&&pcat=<%=pcat%>&&pbrand=<%=pbrand%>&&price=<%=price%>&&spec=<%=spec%>" style="color: Black; font-weight: bolder;">Generate QR Code</a></td>  
