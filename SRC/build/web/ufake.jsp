            ...
            <div class="card-body">
             ...
             <table class="table table-hover">
                ...
                <%
                 ...
                 PreparedStatement ps=con.prepareStatement("Select * from product1 where status='Fake Product' group by 'pid'");
               ...
               <td><%=rate%></td>
                  <td><%=status%></td>
                  <td><a href="qr1.jsp?status=<%=status%>" style="color: Black; font-weight: bolder;">Generate </a></td>  
